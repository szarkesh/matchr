...
function Quiz(props) {
  ...
  let partner_text =
    "Answer the questions below, and we will match you with a participant best suited for your expertise!";
              ...
              <div className="grid md:grid-cols-2 md:gap-x-8">
                {question.choices.map((choice) => (
                  ...
                  >
                    ...
                    <Input
                      value={
                        responses[question.id] && responses[question.id][choice]
                      }
                      onChange={(event) =>
                        setResponses({
                          ...responses,
            ...
            {questionType(question) == "select" && (
              <Select
                ...
                isOptionDisabled={() =>
                  ...
                  responses[question.id]?.length >= question.selection_range[1]
                }
